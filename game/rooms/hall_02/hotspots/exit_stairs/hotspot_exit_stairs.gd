...
func _on_click() -> void:
    await RoomUtil.use_door(R.FrontDesk)


# Teleport: Node is double left clicked.
func _on_double_click() -> void:
    await RoomUtil.teleport_door(R.FrontDesk)


# Look: When the node is right clicked.
func _on_right_click() -> void:
    await RoomUtil.look_door("The front desk is down the stairs and it's the perfect place to greet new guests.")

...
func _on_click() -> void:
    await InteractUtil.approach_and_say("A fun house mirror. My body and face are wobbly and distorted.")
    await C.player.say("My reflection doesn’t fare much better.")

...
func _on_click() -> void:
    await InteractUtil.approach_and_say("I guess I'm done for the day.")
...
func _on_right_click() -> void:
    await InteractUtil.face_and_say("I can turn out the light when I'm ready to retire for the night.")

...
func _on_click() -> void:
    await InteractUtil.approach_and_say("Only a few days left before the Inspector shows up.")
...
func _on_right_click() -> void:
    await InteractUtil.face_and_say("My calendar showing the current month and some alarming upcoming events.")
